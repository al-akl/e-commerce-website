...
<body>
    ...
    <div class="container">
        ...
        <form method="POST" id="addStockForm" class="forms">
            <input type="text" id="barcode" name="barcode" placeholder="Barcode" required>
            <input type="number" id="stock" name="stock" placeholder="Quantity" required>
            <button type="submit" name="addStock">Add Quantity</button>
            <p id="message"></p>
        </form>
